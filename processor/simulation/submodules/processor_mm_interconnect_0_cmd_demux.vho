...
--synthesis_resources = 
 ...
 ENTITY  processor_mm_interconnect_0_cmd_demux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END processor_mm_interconnect_0_cmd_demux;

 ARCHITECTURE RTL OF processor_mm_interconnect_0_cmd_demux IS
	 ...
	 SIGNAL  s_wire_processor_mm_interconnect_0_cmd_demux_wideor0_11_dataout :	STD_LOGIC;
 ...
 BEGIN
	...
	s_wire_processor_mm_interconnect_0_cmd_demux_wideor0_11_dataout <= ((((wire_w_lg_w_sink_channel_range1w2w(0) OR wire_w_lg_w_sink_channel_range3w4w(0)) OR wire_w_lg_w_sink_channel_range6w7w(0)) OR wire_w_lg_w_sink_channel_range9w10w(0)) OR wire_w_lg_w_sink_channel_range12w13w(0));
	sink_ready <= s_wire_processor_mm_interconnect_0_cmd_demux_wideor0_11_dataout;
 ...
 END RTL; --processor_mm_interconnect_0_cmd_demux
