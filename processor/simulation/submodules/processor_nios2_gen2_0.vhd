...
entity processor_nios2_gen2_0 is
	port (
		clk                                 : in  std_logic                     := '0';             --                       clk.clk
		reset_n                             : in  std_logic                     := '0';             --                     reset.reset_n
		reset_req                           : in  std_logic                     := '0';             --                          .reset_req
		d_address                           : out std_logic_vector(13 downto 0);                    --               data_master.address
		...
		i_address                           : out std_logic_vector(13 downto 0);                    --        instruction_master.address
...
end entity processor_nios2_gen2_0;

architecture rtl of processor_nios2_gen2_0 is
	component processor_nios2_gen2_0_cpu is
		port (
	...
	end component processor_nios2_gen2_0_cpu;

begin

	cpu : component processor_nios2_gen2_0_cpu
		port map (
			clk                                 => clk,                                 --                       clk.clk
...
end architecture rtl; -- of processor_nios2_gen2_0
