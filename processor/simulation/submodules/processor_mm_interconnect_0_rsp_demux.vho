...
--synthesis_resources = 
 ...
 ENTITY  processor_mm_interconnect_0_rsp_demux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END processor_mm_interconnect_0_rsp_demux;

 ARCHITECTURE RTL OF processor_mm_interconnect_0_rsp_demux IS
 ...
 END RTL; --processor_mm_interconnect_0_rsp_demux
