...
--synthesis_resources = 
 ...
 ENTITY  processor_mm_interconnect_0_cmd_demux_001 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END processor_mm_interconnect_0_cmd_demux_001;

 ARCHITECTURE RTL OF processor_mm_interconnect_0_cmd_demux_001 IS
 ...
 END RTL; --processor_mm_interconnect_0_cmd_demux_001
