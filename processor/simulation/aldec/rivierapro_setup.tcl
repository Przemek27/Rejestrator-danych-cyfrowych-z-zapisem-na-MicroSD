...
alias com {
  ...
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/aldec/altera_merlin_slave_agent.sv"                                           -work jtag_uart_0_avalon_jtag_slave_agent         
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/aldec/altera_merlin_burst_uncompressor.sv"                                    -work jtag_uart_0_avalon_jtag_slave_agent         
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/aldec/altera_merlin_master_agent.sv"                                          -work nios2_gen2_0_data_master_agent              
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/aldec/altera_merlin_slave_translator.sv"                                      -work jtag_uart_0_avalon_jtag_slave_translator    
