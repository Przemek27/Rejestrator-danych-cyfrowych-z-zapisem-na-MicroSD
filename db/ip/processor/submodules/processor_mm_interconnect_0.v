...
module processor_mm_interconnect_0 (
	...
	wire   [7:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> nios2_gen2_0_debug_mem_slave_agent:cp_channel
	...
	wire  [92:0] altpll_0_pll_slave_agent_rf_source_data;                                            // altpll_0_pll_slave_agent:rf_source_data -> altpll_0_pll_slave_agent_rsp_fifo:in_data
	...
	wire  [92:0] altpll_0_pll_slave_agent_rsp_fifo_out_data;                                         // altpll_0_pll_slave_agent_rsp_fifo:out_data -> altpll_0_pll_slave_agent:rf_sink_data
	...
	wire  [91:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> altpll_0_pll_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                              // altpll_0_pll_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [7:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> altpll_0_pll_slave_agent:cp_channel
	...
	wire   [7:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> timer_0_s1_agent:cp_channel
	...
	wire  [91:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> pio_1_s1_agent:cp_data
	...
	wire  [15:0] spi_0_spi_control_port_agent_m0_address;                                            // spi_0_spi_control_port_agent:m0_address -> spi_0_spi_control_port_translator:uav_address
	...
	wire  [91:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> spi_0_spi_control_port_agent:cp_data
	...
	wire  [91:0] altpll_0_pll_slave_agent_rp_data;                                                   // altpll_0_pll_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [91:0] pio_1_s1_agent_rp_data;                                                             // pio_1_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [91:0] spi_0_spi_control_port_agent_rp_data;                                               // spi_0_spi_control_port_agent:rp_data -> router_009:sink_data
	...
	wire  [91:0] cmd_demux_src1_data;                                                                // cmd_demux:src1_data -> crosser:in_data
	...
	wire  [91:0] crosser_out_data;                                                                   // crosser:out_data -> cmd_mux_001:sink0_data
	...
	wire  [91:0] rsp_demux_001_src0_data;                                                            // rsp_demux_001:src0_data -> crosser_001:in_data
	...
	wire  [91:0] crosser_001_out_data;                                                               // crosser_001:out_data -> rsp_mux:sink1_data
	...
	processor_mm_interconnect_0_router_002 router_004 (
	...
	processor_mm_interconnect_0_router_003 router_006 (
	...
	processor_mm_interconnect_0_router_003 router_007 (
	...
	processor_mm_interconnect_0_router_003 router_008 (
	...
	processor_mm_interconnect_0_router_003 router_009 (
	...
	processor_mm_interconnect_0_cmd_mux_001 cmd_mux_004 (
		.clk                 (altpll_0_c0_clk),                                //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	processor_mm_interconnect_0_cmd_mux_001 cmd_mux_005 (
		.clk                 (altpll_0_c0_clk),                                //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	processor_mm_interconnect_0_cmd_mux_001 cmd_mux_006 (
		.clk                 (altpll_0_c0_clk),                                //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	processor_mm_interconnect_0_cmd_mux_001 cmd_mux_007 (
		.clk                 (altpll_0_c0_clk),                                //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	processor_mm_interconnect_0_cmd_demux_001 rsp_demux (
		.clk                (altpll_0_c0_clk),                                //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	processor_mm_interconnect_0_rsp_demux_003 rsp_demux_003 (
		.clk                (altpll_0_c0_clk),                           //       clk.clk
		.reset              (timer_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	processor_mm_interconnect_0_rsp_demux_003 rsp_demux_004 (
		.clk                (altpll_0_c0_clk),                                //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	processor_mm_interconnect_0_rsp_demux_003 rsp_demux_005 (
		.clk                (altpll_0_c0_clk),                                //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	processor_mm_interconnect_0_rsp_demux_003 rsp_demux_006 (
		.clk                (altpll_0_c0_clk),                                //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	processor_mm_interconnect_0_rsp_demux_003 rsp_demux_007 (
		.clk                (altpll_0_c0_clk),                                //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
