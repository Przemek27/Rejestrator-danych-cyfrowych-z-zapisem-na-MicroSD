...
module processor_mm_interconnect_0 (
	...
	wire   [6:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> nios2_gen2_0_debug_mem_slave_agent:cp_channel
	...
	wire  [90:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> altpll_0_pll_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                              // altpll_0_pll_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [6:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> altpll_0_pll_slave_agent:cp_channel
	...
	wire  [90:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> uart_0_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // uart_0_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [6:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> uart_0_s1_agent:cp_channel
	...
	wire  [14:0] spi_0_spi_control_port_agent_m0_address;                                            // spi_0_spi_control_port_agent:m0_address -> spi_0_spi_control_port_translator:uav_address
	...
	wire  [91:0] spi_0_spi_control_port_agent_rf_source_data;                                        // spi_0_spi_control_port_agent:rf_source_data -> spi_0_spi_control_port_agent_rsp_fifo:in_data
	...
	wire  [91:0] spi_0_spi_control_port_agent_rsp_fifo_out_data;                                     // spi_0_spi_control_port_agent_rsp_fifo:out_data -> spi_0_spi_control_port_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> spi_0_spi_control_port_agent:cp_data
	...
	wire  [90:0] altpll_0_pll_slave_agent_rp_data;                                                   // altpll_0_pll_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [90:0] timer_0_s1_agent_rp_data;                                                           // timer_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [90:0] uart_0_s1_agent_rp_data;                                                            // uart_0_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [90:0] spi_0_spi_control_port_agent_rp_data;                                               // spi_0_spi_control_port_agent:rp_data -> router_008:sink_data
	...
	wire  [90:0] cmd_demux_src1_data;                                                                // cmd_demux:src1_data -> crosser:in_data
	...
	wire  [90:0] crosser_out_data;                                                                   // crosser:out_data -> cmd_mux_001:sink0_data
	...
	wire  [90:0] rsp_demux_001_src0_data;                                                            // rsp_demux_001:src0_data -> crosser_001:in_data
	...
	wire  [90:0] crosser_001_out_data;                                                               // crosser_001:out_data -> rsp_mux:sink1_data
